...
<form method="post" action="index.php">
	...
	<input type="hidden" name="task" value="saveintro" />
...
<fieldset class="list-fieldset">
	...
	if($this->rows->stories)
	{
		...
		{
			$elink = 'index.php?option=com_wedding&view=card&layout=edit&id='.$story->id.'&Itemid='.JRequest::getInt('Itemid');
			$dlink = 'index.php?option=com_wedding&view=card&layout=remove&id='.$story->id.'&Itemid='.JRequest::getInt('Itemid');
	?>
		<tr>
			<td><?php echo $i+1;?></td>
			<td>
