...
<form method="post" action="index.php" enctype="multipart/form-data">
	...
	<input type="hidden" name="view" value="diary" />
...
<fieldset class="list-fieldset">
	...
	if($this->rows->stories)
	{
		...
		{
			$elink = 'index.php?option=com_wedding&view=diary&layout=edit&id='.$story->id.'&Itemid='.JRequest::getInt('Itemid');
			$dlink = 'index.php?option=com_wedding&view=diary&layout=remove&id='.$story->id.'&Itemid='.JRequest::getInt('Itemid');
	?>
		<tr>
			<td><?php echo $i+1;?></td>
			<td>
