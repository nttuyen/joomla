<?php
class weddingControllerDiary extends weddingController 
{
	...
	function listitems()
	{
		...
		$this->_view->setLayout('diary.list');
	...
	function edit()
	{
		...
		$this->_view->setLayout('diary.edit');
		$this->_view->edit($rows);
	}
	
	function save()
	{
		$url = 'index.php?option=com_wedding&view=diary&layout=listitems&Itemid='.JRequest::getInt('Itemid');
	...
	function remove()
	{
		...
		$url = 'index.php?option=com_wedding&view=diary&layout=listitems&Itemid='.$Itemid;
