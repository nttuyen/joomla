...
class weddingControllerStory extends weddingController 
{
	...
	function listitems()
	{
		...
		$this->_view->setLayout('story.list');
	...
	function edit()
	{
		...
		$this->_view->setLayout('story.edit');
		$this->_view->edit($rows);
	}
	
	function save()
	{
		$url = 'index.php?option=com_wedding&view=story&layout=listitems&Itemid='.JRequest::getInt('Itemid');
	...
	function remove()
	{
		...
		$url = 'index.php?option=com_wedding&view=story&layout=listitems&Itemid='.$Itemid;
