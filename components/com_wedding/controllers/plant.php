<?php
class weddingControllerPlant extends weddingController 
{
	...
	function listitems()
	{
		...
		$this->_view->setLayout('plant.list');
	...
	function edit()
	{
		...
		$this->_view->setLayout('plant.edit');
		$this->_view->edit($rows);
	}
	
	function save()
	{
		$url = 'index.php?option=com_wedding&view=plant&layout=listitems&Itemid='.JRequest::getInt('Itemid');
	...
	function remove()
	{
		...
		$url = 'index.php?option=com_wedding&view=plant&layout=listitems&Itemid='.$Itemid;
