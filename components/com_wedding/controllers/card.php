<?php
class weddingControllerCard extends weddingController 
{
	...
	function listitems()
	{
		...
		$this->_view->setLayout('card.list');
	...
	function edit()
	{
		...
		$this->_view->setLayout('card.edit');
		$this->_view->edit($rows);
	}
	
	function save()
	{
		$url = 'index.php?option=com_wedding&view=card&layout=listitems&Itemid='.JRequest::getInt('Itemid');
	...
	function remove()
	{
		...
		$url = 'index.php?option=com_wedding&view=card&layout=listitems&Itemid='.$Itemid;
