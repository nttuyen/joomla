<?php
class weddingControllerThanks extends weddingController 
{
	...
	function listitems()
	{
		...
		$this->_view->setLayout('thanks.list');
	...
	function edit()
	{
		...
		$this->_view->setLayout('thanks.edit');
		$this->_view->edit($rows);
	}
	
	function save()
	{
		$url = 'index.php?option=com_wedding&view=thanks&layout=listitems&Itemid='.JRequest::getInt('Itemid');
	...
	function remove()
	{
		...
		$url = 'index.php?option=com_wedding&view=thanks&layout=listitems&Itemid='.$Itemid;
