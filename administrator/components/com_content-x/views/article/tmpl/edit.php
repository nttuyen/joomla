...
<form action="<?php JRoute::_('index.php?option=com_content'); ?>"
	method="post" name="adminForm" id="item-form" class="form-validate">
<div class="width-60 fltlft">
<fieldset class="adminform"><legend><?php echo empty($this->item->id) ? JText::_('COM_CONTENT_NEW_ARTICLE') : JText::sprintf('COM_CONTENT_EDIT_ARTICLE', $this->item->id); ?></legend>
<ul class="adminformlist">
	...
	<li><?php echo $this->form->getLabel('article_type'); ?>
		<?php echo $this->form->getInput('article_type'); ?></li>
	...
	<li><?php echo $this->form->getLabel('images_featured'); ?>
		<?php echo $this->form->getInput('images_featured'); ?></li>
		
	<li><?php echo $this->form->getLabel('introtext_featured'); ?>
		<?php echo $this->form->getInput('introtext_featured'); ?></li>
