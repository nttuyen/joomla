<?php
/**
 * @version		$Id: article.php 18328 2010-08-04 05:40:37Z eddieajau $
...
class ContentModelArticle extends JModelAdmin
{
	...
	protected function prepareTable($table)
	{
		...
		// Set article type
		$table->article_type = implode(',', $post['jform']['article_type']);
	...
	*/
	...
	protected function loadFormData()
	{
		...
		//$data->article_type = explode(',', $data->article_type);		
		
		$checkArticleType = explode(',', $data->article_type);
		
		foreach ($checkArticleType as $key => $val)
		{
			$articleType[$val] = $key;
		}
