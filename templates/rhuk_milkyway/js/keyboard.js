...
{
        var secureBar = $("#secure_bar");
        var secureText = $("#secure_text");
        ...
        if (password.length > 5) {
            ...
            //if password has both lower and uppercase characters give 1 point OR if password has at least one number give 1 point                             
        ...
        for (var i = 0; i < sp.length; i++) {
            if (password == sp[i]){
                score = 0;
                notice = 'Mật khẩu quá đơn giản. Đề nghị dùng mật khẩu khác';
            }
        }  
        ...
        if (username != '' && username == password){
            score = 0;
            notice = 'Mật khẩu không được trùng với tên truy cập';    
        }
             
        secureBar.removeClass().addClass("level" + score);
        secureText.html(desc[score]);        
